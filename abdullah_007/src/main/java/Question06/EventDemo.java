...
public class EventDemo {
    ...
    public static void main(String[] args) {
        ...
        x.displayMethod();
         System.out.println("Now Price =  " +EventDemo.inclusiveDataPrice(e));
        System.out.println("**************************************************************\n");
        ...
        v.displayMethod();
         System.out.println("Now Price =  " +EventDemo.inclusiveDataPrice(y));
        System.out.println("**************************************************************\n");
        ...
        a.displayMethod();
        System.out.println("Now Price =  " +EventDemo.inclusiveDataPrice(o));
        for(int h=0;h<o;h++){
