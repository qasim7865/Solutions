...
public class Event
{
    ...
    private String eventTypeName[] = {new String("Wedding"), new String("Baptism"),
            new String("Birthday"), new String("Corporate") , new String("Other")};
    ...
    public void setEventType(int index)
    {
        if(index >= 0 && index <= 4)
        {
            eventType = index;
