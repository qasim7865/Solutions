...
public class RentalDemo {
	...
	public static void main(String[] args) {
		...
		firstObj.setNumber(as.getNumber());
		...
		secondObj.setNumber(as.getNumber());
		...
		thirdObj.setNumber(as.getNumber());
		...
		//______________________________________________________________________
		//Loop to Display Statement as much times as their hours in First Object	
		System.out.println("\n\nDisplaying Statement as much times as there are hours in First Object\n");
	for(int u = 0;u<firstObj.getNumberofHours();u++) {
